...
#     image = Image.fromarray(array)
#     root = Tk()
#     root.title("Label the Novelty")
#
#     # Use ttk for better-styled widgets
#     style = ttk.Style(root)
...
#     # Styling
#     root.configure(bg='#f0f0f0')
#     customFont = tkFont.Font(family="Segoe UI", size=12)
#
#     tk_image = ImageTk.PhotoImage(image)
#
#     img_label = Label(root, image=tk_image, borderwidth=2, relief="solid")
...
#     status_label = ttk.Label(root, text="Enter a label for the image:", font=customFont)
#     status_label.grid(row=1, column=0, sticky='w', padx=20, pady=(0, 10))
#
#     label_entry = ttk.Entry(root, font=customFont)
#     label_entry.grid(row=1, column=1, padx=20, pady=(0, 10))
#
#     def on_button_click():
#         label = label_entry.get()
#         if label:
...
# import os
# from tkinter import Tk, Label, Entry, Button, messagebox, Toplevel, font as tkFont
# from PIL import Image, ImageTk
#
# def save_labeled_image(image, label, folder="labelled_images"):
#     if not os.path.exists(folder):
...
#     img_label.grid(row=0, column=0, columnspan=2, padx=20, pady=20)
#
#     status_label = Label(root, text="Enter a label for the image:", font=customFont, bg='#f0f0f0')
#     status_label.grid(row=1, column=0, sticky='w', padx=20, pady=(0, 10))
#
#     label_entry = Entry(root, font=customFont)
#     label_entry.grid(row=1, column=1, padx=20, pady=(0, 10))
#
#     def on_button_click():
#         label = label_entry.get()
...
#             messagebox.showerror("Error", "Please enter a label")
#
#     button = Button(root, text="Save Label", command=on_button_click, font=customFont)
#     button.grid(row=2, column=0, columnspan=2, pady=10)
#
#     root.mainloop()
